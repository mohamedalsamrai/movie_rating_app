...
abstract class AppLocalizations {
  ...
  /// No description provided for @filmz.
  ///
  /// In en, this message translates to:
  /// **'Filmz'**
  String get filmz;

  /// No description provided for @filmzSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @searchedMoviesTitle.
  ///
  /// In en, this message translates to:
  /// **'Movies 🎬'**
  String get searchedMoviesTitle;
}
